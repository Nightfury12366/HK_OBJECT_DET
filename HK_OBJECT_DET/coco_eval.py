...
ap.add_argument('--is_dibiao', type=bool, default=False, help='测试国旗还是地标')
...
if args.is_dibiao is False:  # 判断加载地标模型还是国旗国徽模型
    project_name = 'GuoQi'
    weights_path = f'weights/efficientdet-d0_guoqi.pth'
else:
    project_name = 'DiBiao'
    weights_path = f'weights/efficientdet-d0_dibiao.pth'
